      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h3 className="text-2xl font-semibold mb-6 dark:text-white">Let's work together</h3>
            ...
            <div className="space-y-4">
              <a href="mailto:alex@example.com" className="flex items-center text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-300">
              ...
              <div className="flex space-x-4 mt-6">
                <a href="#" className="bg-gray-200 dark:bg-gray-700 p-3 rounded-full text-gray-600 dark:text-gray-300 hover:bg-indigo-600 hover:text-white dark:hover:bg-indigo-600 dark:hover:text-white transition-colors duration-300">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-lg">
              <div className="mb-4">
