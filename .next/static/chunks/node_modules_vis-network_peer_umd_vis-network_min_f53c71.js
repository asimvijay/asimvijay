(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_vis-network_peer_umd_vis-network_min_f53c71.js", {

"[project]/node_modules/vis-network/peer/umd/vis-network.min.js [app-client] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ !function(t, e) {
    ("TURBOPACK compile-time truthy", 1) ? e(exports, __turbopack_require__("[project]/node_modules/vis-data/peer/umd/vis-data.js [app-client] (ecmascript)")) : ("TURBOPACK unreachable", undefined);
}(this, function(t, e) {
    ...
    var md = it, bd = Jt, wd = gd, kd = Qe.f, _d = function(t) {
        ...
        return function(h, d, l, c) {
            for(var u, f, p = Pd(h), v = Md(p), g = Td(d, l), y = Dd(v), m = 0, b = c || Id, w = e ? b(h, y) : i || s ? b(h, 0) : void 0; y > m; m++)if ((a || m in v) && (f = g(u = v[m], m, p), t)) if (e) w[m] = f;
            else if (f) switch(t){
                case 3:
                    return !0;
                case 5:
    ...
    }, lv = o(dv), cv = "\t\n\v\f\r                　\u2028\u2029\ufeff", uv = G, fv = un, pv = cv, vv = y("".replace), gv = RegExp("^[" + pv + "]+"), yv = RegExp("(^|[^" + pv + "])[" + pv + "]+$"), mv = function(t) {
        return function(e) {
            var i = fv(uv(e));
    ...
    function zm(t, e) {
        ...
        for(var o in t)if (void 0 !== e[o]) if (null === e[o] || "object" !== gu(e[o])) Fm(t, e, o, i);
        else {
            var n = t[o], r = e[o];
            Bm(n) && Bm(r) && zm(n, r, i);
        }
    ...
    function Nm(t, e, i) {
        ...
        for(var n = 0; n < t.length; n++){
            var r = t[n];
            if (Object.prototype.hasOwnProperty.call(i, r)) if (i[r] && i[r].constructor === Object) void 0 === e[r] && (e[r] = {}), e[r].constructor === Object ? Rm(e[r], i[r], !1, o) : Fm(e, i, r, o);
            else {
    ...
    function Am(t, e, i) {
        var o = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
        if (Of(i)) throw new TypeError("Arrays are not supported by deepExtend");
        for(var n in i)if (Object.prototype.hasOwnProperty.call(i, n) && !Qp(t).call(t, n)) if (i[n] && i[n].constructor === Object) void 0 === e[n] && (e[n] = {}), e[n].constructor === Object ? Rm(e[n], i[n]) : Fm(e, i, n, o);
        else if (Of(i[n])) {
            e[n] = [];
    ...
    function Rm(t, e) {
        ...
        for(var n in e)if (Object.prototype.hasOwnProperty.call(e, n) || !0 === i) if ("object" === gu(e[n]) && null !== e[n] && ov(e[n]) === Object.prototype) void 0 === t[n] ? t[n] = Rm({}, e[n], i) : "object" === gu(t[n]) && null !== t[n] && ov(t[n]) === Object.prototype ? Rm(t[n], e[n], i) : Fm(t, e, n, o);
        else if (Of(e[n])) {
            var r;
            t[n] = mf(r = e[n]).call(r);
        } else Fm(t, e, n, o);
    ...
    function qm(t, e, i) {
        var o;
        return "#" + mf(o = ((1 << 24) + (t << 16) + (e << 8) + i).toString(16)).call(o, 1);
    }
    function Um(t, e) {
        if (Im(t)) {
            var i = t;
    ...
    function jb() {
        ...
        if (Qp(s).call(s, "dir")) {
            ...
            if (!Qp(s).call(s, "arrows")) if ("both" === u) r.push({
                attr: r[d.dir].attr,
                name: "arrows",
                value: {
                    to: {
                ...
                value: function(t, e) {
                    ...
                    for(var d = 0; d < n.edges.length; d++){
                        ...
                        if (void 0 === this.clusteredEdges[l.id]) {
                            ...
                            if (void 0 === this.clusteredNodes[c]) if (c !== a) if (void 0 === e.joinCondition) s[l.id] = l, r[c] = this.body.nodes[c];
                            else {
                ...
                value: function(t) {
                    ...
                    if (0 === n || 0 === r) o = 1, i = mO.getRange(this.body.nodes, t.nodes);
                        ...
                        for(var a in this.body.nodes){
                            if (Object.prototype.hasOwnProperty.call(this.body.nodes, a)) !0 === this.body.nodes[a].predefinedPosition && (s += 1);
                        }
            ...
            },
            {
                ...
                value: function(t) {
                    if (void 0 !== t) {
                        ...
                        }, 0 === t.animation.duration) if (null != this.lockedOnNodeId) this.viewFunction = Wo(e = this._lockedRedraw).call(e, this), this.body.emitter.on("initRedraw", this.viewFunction);
...
//# sourceMappingURL=node_modules_vis-network_peer_umd_vis-network_min_f53c71.js.map